        ...
        <NavSection>
           <ToggleBtn className={menuClass} onClick={toggleMenu}/>
            <Nav className={menuClass}>
                ...
                <MenuList>
                    <MenuItem><NavLink onClick={linkClick} to="/my-polls" ><img alt="Мои Опросы" src={personIcon}/><span>Мои опросы</span></NavLink></MenuItem>
                    <MenuItem><NavLink onClick={linkClick} to="/all-polls"><img alt="Опросы" src={questionIcon}/><span>Опросы</span></NavLink></MenuItem>
                    <MenuItem><NavLink onClick={linkClick} to="/create-poll"><img alt="Создать Опрос" src={bulbIcon}/><span>Создать опрос</span></NavLink></MenuItem>
                    ...
                    <MenuItem><NavLink onClick={linkClick} to="/statistics"><img alt="Статистика" src={statsIcon}/><span>Статистика</span></NavLink></MenuItem>
                    { <MenuItem><NavLink onClick={linkClick} to="/profile"><img alt="Профиль" src={settingsIcon}/><span>Профиль</span></NavLink></MenuItem> }
                </MenuList>
            </Nav> 
        </NavSection>
        </Router>
