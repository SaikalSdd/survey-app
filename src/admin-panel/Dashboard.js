                ...
                <div className="card-body">
                  ...
                  <div className="direct-chat-messages">
                    ...
                    <div className="direct-chat-msg">
                      ...
                      {/* /.direct-chat-infos */}
                      <img className="direct-chat-img" src="admin-assets/dist/img/user1-128x128.jpg" alt="message user image" />
                      {/* /.direct-chat-img */}
                    ...
                    <div className="direct-chat-msg right">
                      ...
                      {/* /.direct-chat-infos */}
                      <img className="direct-chat-img" src="admin-assets/dist/img/user3-128x128.jpg" alt="message user image" />
                      {/* /.direct-chat-img */}
                      <div className="direct-chat-text">
                  ...
                  <div className="direct-chat-contacts">
                    <ul className="contacts-list">
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user1-128x128.jpg" />
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user7-128x128.jpg" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Sarah Doe
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user3-128x128.jpg" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nadia Jolie
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user5-128x128.jpg" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nora S. Vans
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user6-128x128.jpg" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              John K.
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="admin-assets/dist/img/user8-128x128.jpg" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Kenneth M.
              ...
              <div className="card">
                ...
                <div className="card-body p-0">
                  <ul className="users-list clearfix">
                    <li>
                      <img src="admin-assets/dist/img/user1-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Alexander Pierce</a>
                      <span className="users-list-date">Today</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user8-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Norman</a>
                      <span className="users-list-date">Yesterday</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user7-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Jane</a>
                      <span className="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user6-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">John</a>
                      <span className="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user2-160x160.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Alexander</a>
                      <span className="users-list-date">13 Jan</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user5-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Sarah</a>
                      <span className="users-list-date">14 Jan</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user4-128x128.jpg" alt="User Image" />
                      <a className="users-list-name" href="#">Nora</a>
                      <span className="users-list-date">15 Jan</span>
                    </li>
                    <li>
                      <img src="admin-assets/dist/img/user3-128x128.jpg" alt="User Image" />
              ...
              <ul className="products-list product-list-in-card pl-2 pr-2">
                <li className="item">
                  <div className="product-img">
                    <img src="admin-assets/dist/img/default-150x150.png" alt="Product Image" className="img-size-50" />
                  </div>
